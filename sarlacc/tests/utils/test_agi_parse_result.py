...
class TestCase(test.TestCase):
    ...
    def test_agi_parse_result_200_0(self):
        code, result, args = utils._agi_parse_result("200 result=0")
        self.assertEqual(code, '200')
        self.assertEqual(result, '0')
        self.assertEqual(args, '')

    def test_agi_parse_result_200_timeout(self):
        code, result, args = utils._agi_parse_result("200 result=0 (timeout)")
        self.assertEqual(code, '200')
        self.assertEqual(result, '0')
        self.assertEqual(args, '(timeout)')

    def test_agi_parse_result_200_timeout_fail(self):
        code, result, args = utils._agi_parse_result("200 result= (timeout)")
        self.assertEqual(code, '200')
        self.assertEqual(result, '')
        self.assertEqual(args, '(timeout)')

    def test_agi_parse_result_200_1(self):
        code, result, args = utils._agi_parse_result("200 result=1")
        self.assertEqual(code, '200')
    ...
    def test_agi_parse_result_520(self):
        code, result, args = utils._agi_parse_result(
