...
from sarlacc.common import exception
from sarlacc.openstack.common import strutils
...
class HTTPClient(object):
    ...
    def _http_request(self, url, method, **kwargs):
        ...
        if resp.getheader('content-type', None) != 'application/octet-stream':
            body_str = ''.join([body for body in body_iter])
...
class VerifiedHTTPSConnection(httplib.HTTPSConnection):
    ...
    def host_matches_cert(host, x509):
        ...
        raise exception.SSLCertificateError(msg)
    ...
    def setcontext(self):
        ...
        if self.cert_file:
            try:
                ...
                raise exception.SSLConfigurationError(msg)
